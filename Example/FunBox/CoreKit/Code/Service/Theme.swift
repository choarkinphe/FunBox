...
public class Theme {
    ...
    public struct Image {
        public static var right_arrow: UIImage? {
            ...
            return UIImage(named: "ic_arrow_right", in: FunCoreKit.bundle, compatibleWith: nil)
        }
        
        public static var left_arrow: UIImage? {
            
            return UIImage(named: "ic_arrow_left", in: FunCoreKit.bundle, compatibleWith: nil)
        }
        public static var more: UIImage? {
            
            return UIImage(named: "ic_more", in: FunCoreKit.bundle, compatibleWith: nil)
        }
        public static var close: UIImage? {
            
            return UIImage(named: "ic_sys_close", in: FunCoreKit.bundle, compatibleWith: nil)
        }
        public struct Toast {
            public static var info: UIImage? {
                UIImage(named: "Toast_tips_info", in: FunCoreKit.bundle, compatibleWith: nil)
            }
            public static var error: UIImage? {
                UIImage(named: "Toast_tips_error", in: FunCoreKit.bundle, compatibleWith: nil)
            }
            public static var done: UIImage? {
                UIImage(named: "Toast_tips_done", in: FunCoreKit.bundle, compatibleWith: nil)
            }
