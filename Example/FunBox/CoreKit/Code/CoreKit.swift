...
public class FunCoreKit: NSObject {
...
extension FunCoreKit: CKModuleProtocol {
...
public extension CKModuleProtocol {
    static func install() {
        // 注册路由表
        FunCoreKit.router.feedPages(JSON: JSONSerialization.fb.json(filePath: routingTablePath, type: [String: String].self))
    }
